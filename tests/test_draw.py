...
from mmodel.draw import draw_model
...
def test_draw_model_no_detail(mmodel_graph):
    ...
    dot_graph = draw_model(mmodel_graph, title="test", show_detail=False)
...
def test_draw_model_detail(mmodel_graph):
    ...
    dot_graph = draw_model(mmodel_graph, title="test")
...
def test_draw_model_subgraph(model_instance):
    """Test change model settings
    ...
    model_instance.create_loop(loop_params=["f"])
    dot_graph = draw_model(
